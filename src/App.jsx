      ...
      <main>
        ...
        <div className="mx-8 pt-20 lg:mx-40 lg:pt-40">
          <div className="max-w-2xl mx-auto">
            <div className="todo-app-wrapper bg-slate-800 flex flex-col items-center justify-items-stretch w-100% gap-6 shadow-md lg:gap-8 border rounded rounded-xl border-slate-600 p-6 lg:py-12 lg:px-16 transition ease-in duration-250 hover:border-slate-500">
